...
//Inside of addItem, invoke displayData() which is a function you did not create (we did) that takes care of some of the work for getting your page 
...
//If the amount of groceries is between 1 and 5, return the string 'NUMBEROFGROCERIES items' with NUMBEROFGROCERIES replaced by the number of items in your 
//groceries array.

// Code Here
function checkGroceryCount() {
    // groceries.length >= 5 ? "That looks like a big trip" : `${groceries.length} item(s)`;
    if (groceries.length >= 5) {
        return "That looks like a big trip";
    } else {
        return `${groceries.length} item(s)`;
    }
}
//////////////////STEP 6////////////////////
