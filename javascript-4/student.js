...
// CODE HERE
let faveColors = ["blue", "pink", "silver"];
//////////////////Step 2////////////////////
...
// CODE HERE
let me = {
    firstname: 'Gabriel kim',
    superHeroName: 'OOF',
    homeTown: 'San Francisco',
    superPowers: ["gaming", "coding", "sleeping"],
...
//////////////////Step 5////////////////////
//Create a function called 'setPowers' that takes in 'arr' as a parameter. In your setPowers function, loop over the arr parameter and run a function we created 
// called createLi(), which will take each item of the array as an argument. Remember, you did not create the createLi function. 
...
// In your function, loop over the obj parameter passed in, and change each keys value to 'redacted'. Outside of the loop but still in the redactInfo function, 
