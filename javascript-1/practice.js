...
//Code here
var lovesCodeChecker = (x) => x == true ? true : false;
...
//Code here
var oddChecker = (num) => num % 2 === 0 ? "the number is even" : "the number is odd";
...
//Code Here
var iLove = (name, love) => `${name} loves ${love}`;
//////////////////PROBLEM 8////////////////////
...
function bigOrSmall(arr) {
	let answers = arr.map(function(element) {
		// element > 100 ? "big" : "small";
		if (element > 100) {
			return "big";
		} else {
			return "small";
...
let totallyAwesome = people.reduce((total, element) => total + element["awesomeLevel"], 0)
// Code Here
